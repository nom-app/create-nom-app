...
const siteConfig = {
  ...
  editUrl: 'https://github.com/nom-app/create-nom-app/edit/master/docs/docs/',
  enableUpdateBy: true,
  enableUpdateTime: true,

  // Used for publishing and more
  projectName: 'create-nom-app',
  organizationName: 'nom-app',
  ...
  headerLinks: [
    ...
    {
      href: 'https://www.github.com/nom-app/create-nom-app',
      label: 'GitHub',
    },
  ...
  */
  ...
  repoUrl: 'https://github.com/nom-app/create-nom-app',
  scrollToTop: true,
};
